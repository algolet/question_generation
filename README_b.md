...
# 默认的question-generation是基于mt5精调的生成模型
...
# Allocate a pipeline for question-generation  
# 默认的question-answering模型是huggingface上的"luhua/chinese_pretrain_mrc_macbert_large"中文qa模型
...
#### github项目地址
``` 
https://github.com/algolet/question_generation
``` 
